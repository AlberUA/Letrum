import "./main.min.js";
import { a as dataMediaQueries, c as slideToggle, l as slideUp, s as gotoBlock, u as uniqArray } from "./common.min.js";
...
function initSliders() {
	if (document.querySelector(".prices__slider")) new Swiper(".prices__slider", {
		modules: [Navigation],
		observer: true,
		observeParents: true,
		slidesPerView: 3,
