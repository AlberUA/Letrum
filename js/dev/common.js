...
window.onload = function() {
	if (document.getElementById("uploadForm")) {
		...
		inputFile.addEventListener("change", (e) => {
			e.target.files[0];
			uploadBtn.textContent = "Додаємо ваш файл...";
			uploadBtn.classList.add("loading");
			setTimeout(() => {
				uploadBtn.textContent = "Файл додано";
				uploadBtn.classList.remove("loading");
				window.flsPopup.open("popup-check");
			}, 1e3);
		});
	}
};
//#endregion
export { dataMediaQueries as a, slideToggle as c, bodyUnlock as i, slideUp as l, bodyLockStatus as n, getHash as o, bodyLockToggle as r, gotoBlock as s, bodyLock as t, uniqArray as u };
